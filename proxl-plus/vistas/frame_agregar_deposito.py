...
###########################################################################
## Class FrameAgregarDeposito
###########################################################################

class FrameAgregarDeposito ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Agregar un nuevo deposito", pos = wx.DefaultPosition, size = wx.Size( 400,225 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, u"Número:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3.Wrap( -1 )
		self.m_staticText3.SetFont( wx.Font( 11, 70, 90, 90, False, wx.EmptyString ) )
		
		gbSizer2.Add( self.m_staticText3, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.TOP|wx.RIGHT|wx.LEFT, 5 )
		...
		gbSizer2.Add( self.m_staticText5, wx.GBPosition( 0, 2 ), wx.GBSpan( 1, 1 ), wx.TOP|wx.RIGHT|wx.LEFT, 5 )
		...
		gbSizer2.Add( self.tc_numero, wx.GBPosition( 1, 0 ), wx.GBSpan( 1, 1 ), wx.BOTTOM|wx.RIGHT|wx.LEFT, 5 )
		...
		gbSizer2.Add( self.tc_fecha, wx.GBPosition( 1, 2 ), wx.GBSpan( 1, 1 ), wx.BOTTOM|wx.RIGHT|wx.LEFT|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		...
		self.btn_aceptar.SetFont( wx.Font( 11, 70, 90, 90, False, wx.EmptyString ) )
