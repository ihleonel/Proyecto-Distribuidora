...
###########################################################################
## Class FrameCajaIngresosVarios
###########################################################################

class FrameCajaIngresosVarios ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Ingresos varios", pos = wx.DefaultPosition, size = wx.Size( 565,229 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.tc_monto.SetForegroundColour( wx.Colour( 0, 64, 0 ) )
